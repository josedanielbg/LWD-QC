...
ax04.fill_betweenx(df1.index,0,df1.flg_CompAD,label="Flag Diferencia entre curvas", color='g') 
...
ax02.fill_betweenx(df3_1.index,0,df3_1.flg_rngALDRes,label="Flag Rango Aceptable", color='g') 
ax02.set_xlabel('En rango [0] - Fuera de rango [1]', color='g')
ax02.tick_params(axis='x', colors='g')
ax02.grid(True)
ax03=ax2[2].twiny()
ax03.invert_xaxis()
ax03.invert_yaxis()
...
ax03.fill_betweenx(df3_1.index,0,df3_1.flag_2,label='Valores nulos', color='r')
...
ax02.fill_betweenx(df3_1.index,0,df3_1.flg_rngALDCuentas,label="Flag Rango Aceptable", color='g') 
ax02.set_xlabel('En rango [0] - Fuera de rango [1]', color='g')
ax02.tick_params(axis='x', colors='g')
ax02.grid(True)
ax03=ax3[2].twiny()
...
ax02.invert_yaxis()
ax02.set_xlim(0,500)
ax02.set_ylim([np.max(df4.index), np.min(df4.index)])
...
ax03.invert_yaxis()
ax03.set_xlim(0,1)
ax03.spines['top'].set_position(('outward',5))
ax03.set_xlabel('Flag_Comportamiento PC')
ax03.fill_betweenx(df4.index,0,df4.flg_CompPC,label="Flag Diferencia entre curvas", color='g') 
ax03.set_xlabel('Curvas Cerca [0] - Curvas Separadas [1]', color='g')
ax03.tick_params(axis='x', colors='g')
ax03.grid(True)
...
ax04.set_xlabel('Flag Valores Nulos')
ax04.fill_betweenx(df4.index,0,df4.flag_2,label='Valores nulos', color='r')
ax04.set_xlabel('Hay valores [0] - No exsiten Valores [1]', color='r')
ax04.tick_params(axis='x', colors='red')
...
ax02.fill_betweenx(df4_1.index,0,df4_1.flg_rngHVS,  label="Flag Rango Aceptable", color='g') 
ax02.set_xlabel('En rango [0] - Fuera de rango [1]', color='g')
ax02.tick_params(axis='x', colors='g')
ax02.grid(True)
...
ax03.fill_betweenx(df4_1.index,0,df4_1.flag_2, label='Valores nulos', color='r')
ax03.set_xlabel('Hay valores [0] - No exsiten Valores [1]', color='r')
ax03.tick_params(axis='x', colors='red')
...
ax03.set_xlabel('flg_CompCA')
ax03.fill_betweenx(df5_1.index,0,df5_1.flg_CompCA, label="Flag Diferencia entre curvas", color='g') 
ax03.set_xlabel('Curvas Cerca [0] - Curvas Separadas [1]', color='g')
ax03.tick_params(axis='x', colors='g')
ax03.grid(True)
...
ax04.spines['top'].set_position(('outward',40))
ax04.set_xlabel('Flag Valores Nulos')
ax04.fill_betweenx(df5_1.index,0,df5_1.flag_2, label='Valores nulos', color='r')
ax04.set_xlabel('Hay valores [0] - No exsisten Valores [1]', color='r')
ax04.tick_params(axis='x', colors='red')
